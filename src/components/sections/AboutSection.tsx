        ...
        <div className="grid md:grid-cols-3 gap-10 items-center">
          ...
          <div className="md:col-span-2 animate-fade-in-delay-1">
            <div className="space-y-4 text-lg leading-relaxed">
              ...
              <p>
                יועצת זוגית, מאמנת אישית ומאסטר ב-NLP, מלווה נשים ליצור זוגיות יציבה, תומכת ואוהבת.
              </p>
              <p>
                אני הייתי במקום שלך, הרגשתי לא מספיק טובה, הרגשתי לבד, הייתי מלאה בחששות ופחדים,
                הייתי מונעת מהפצעים שלי.. ואז הבנתי — הכוח בידיים שלי.
              </p>
              <p>
              ...
              <p>
                מתוך ההבנה הזו בניתי שיטה שמשלבת עומק רגשי אמיתי עם כלים פרקטיים לוויסות עצמי ותקשורת בריאה.
              </p>
              <p>שיטה שמביאה שינוי גם כשהבן זוג לא משתנה.</p>
              <p>
                אם את מרגישה שיש בך רצון לשינוי, נמאס לך להרגיש לבד ואת רוצה זוגיות טובה ואוהבת — אני כאן בשבילך.
              </p>
              <p>
          ...
          <div className="animate-fade-in-delay-2 flex justify-center">
            <div className="w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden shadow-soft-lg border-4 border-background">
              <img
                src={lielPortrait}
                alt="ליאל ישראל"
