...
const faqs = [
  {
    ...
    answer: "רוב הנשים מרגישות שינוי כבר אחרי המפגש הראשון — בעיקר בתחושת ההבנה והבהירות. שינוי התנהגותי מורגש בדרך כלל תוך 2-3 שבועות.",
  },
  {
  ...
  },
  {
    ...
    answer: "זה בדיוק למה התהליך עובד. את לא תלויה בשינוי שלו. את לומדת לשנות את התגובות שלך — וזה משנה את הדינמיקה כולה.",
  },
  {
  ...
  },
  {
    ...
    answer: "בטיפול זוגי שניכם נוכחים. כאן, העבודה היא אישית — את לומדת לשנות את עצמך, מה שמשנה את האינטראקציה גם כשהוא לא משתנה.",
  },
  {
    question: "האם זה מתאים גם לזוגיות חדשה?",
    answer: "התהליך מיועד בעיקר לנשים בזוגיות ארוכה (3+ שנים). אם את בזוגיות חדשה יותר, נבדוק יחד בשיחת ההתאמה אם זה מתאים.",
  },
  {
