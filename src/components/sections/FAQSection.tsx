...
const relationshipFaqs = [
  {
    ...
    answer:
      "כבר אחרי מפגש ראשון את תביני את שורש הבעיה ותחווי תחושת בהירות והבנה. כמובן שבכל מפגש מקבלים משימות ולכן בכל מפגש תראי עוד שינוי ועוד תוצאה.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "זה בדיוק למה התהליך עובד. את לא תלויה בשינוי שלו. את לומדת לשנות את העולם הפנימי שלך וזה משנה את הדינמיקה כולה.",
  },
  {
    question: "מה ההבדל מטיפול זוגי?",
    answer:
      "בטיפול זוגי שניכם נוכחים. כאן, העבודה היא אישית לחלוטין. את לומדת לשנות ולהכיר את עצמך, מה שמשנה את האינטראקציה גם כשהוא לא משתנה.",
  },
  {
    question: "האם זה מתאים לי גם אם אני לא בזוגיות?",
    answer:
      "בהחלט כן. ישנו מסלול שמתאים לרווקות. התהליך הוא אישי מה שמוביל לזוגיות בריאה ויציבה ולכן גם אם את לא נמצאת בזוגיות כרגע אנחנו נבנה את הבסיס המדויק ביותר לזוגיות שתכנס לך לחיים.",
  },
  {
...
const singleFaqs = [
  {
    ...
    answer:
      "אני מבינה את המחשבה, אבל מדובר בתהליך אישי שמחבר אותך לעצמך. ברגע שאת תעברי את התהליך את תכנסי לזוגיות בריאה. הזוגיות עצמה לא משנה, משנה מי את בתוכה.",
  },
  {
    question: "איך התהליך הזה עוזר לי לבחור נכון בזוגיות?",
    answer:
      "בתהליך אנחנו מתמקדות בך ומבינות את הצרכים והרצונות הכי עמוקים שלך, אנחנו מרפאות פצעים מהעבר וכך אנחנו מצליחות להכנס לזוגיות מתוך מקום בוגר ובשל.",
  },
  {
    question: "האם יש תמיכה בין המפגשים?",
    answer:
      "כן, יש ליווי ותמיכה שמאפשרים לשלב את הכלים ביום-יום ולהרגיש ביטחון בכל צעד. אני זמינה לכל שאלה גם בין המפגשים ותמיד שמחה לשמוע על התקדמויות ודברים שצצים במהלך השבוע.",
  },
  {
