    ...
    <section id="contact-form" className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          maskImage: "linear-gradient(to bottom, rgba(0,0,0,0.32) 0%, rgba(0,0,0,0.18) 40%, rgba(0,0,0,0.05) 75%, rgba(0,0,0,0) 100%)",
          WebkitMaskImage: "linear-gradient(to bottom, rgba(0,0,0,0.32) 0%, rgba(0,0,0,0.18) 40%, rgba(0,0,0,0.05) 75%, rgba(0,0,0,0) 100%)",
        }}
      />
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: "linear-gradient(to bottom, hsla(30,60%,98%,0.45) 0%, hsla(30,60%,98%,0.65) 45%, hsla(30,60%,98%,0.9) 80%, hsla(30,60%,98%,1) 100%)",
        }}
      />
