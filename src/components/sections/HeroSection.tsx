    ...
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="container max-w-5xl relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 animate-fade-in-delay-2">
          ...
          {path === "single" ? <>את רוצה להיכנס לזוגיות שנכונה לך אחת ולתמיד?<br />אני כאן כדי לעזור לך לשחרר את מה שמעכב אותך וליצור את הזוגיות שאת רוצה, אחת כזו שמרגישה בטוחה, יציבה ואוהבת באמת</>
            ) : (
              <>
