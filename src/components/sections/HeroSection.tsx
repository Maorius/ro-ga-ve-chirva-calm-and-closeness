  ...
  return (
    <section className="relative py-12 md:py-20 overflow-hidden">
      ...
      <div className="container max-w-5xl relative z-10">
        {/* Title */}
        <div className="text-center animate-fade-in mb-3 md:mb-4">
          ...
          <h2 className="text-lg md:text-xl text-charcoal-light mb-5 md:mb-6">
            בלי ויכוחים, בלי מלחמות ומבלי לוותר על עצמך
          </h2>
        </div>

        {/* Body text */}
        <div className="text-center max-w-2xl mx-auto mb-7 md:mb-8 animate-fade-in-delay-2">
