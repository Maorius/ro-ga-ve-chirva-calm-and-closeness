      ...
      <div className="container max-w-5xl relative z-10">
        ...
        <div className="text-center animate-fade-in mb-4">
          <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 text-foreground">
            <span className="text-gradient-pink text-[28px] sm:text-[36px] md:text-[42px] leading-tight md:whitespace-nowrap">את יכולה ליצור את הזוגיות שאת חולמת עליה</span>
          </h1>
