...
const copyByPath = {
  ...
  single: "אולי את יוצאת לדייטים, אבל זה לא מתקדם למשהו אמיתי. אולי יש התחלה של חיבור, אבל זה לא מחזיק לאורך זמן.", "את רוצה זוגיות, אבל שוב ושוב מוצאת את עצמך בקשרים שלא מתפתחים או נגמרים מהר. את נותנת הזדמנות, מתאמצת שזה יעבוד, ומקווה שהפעם זה יהיה אחרת."
